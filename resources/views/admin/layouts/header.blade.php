    ...
    <div class="header-wrapper row m-0">
        ...
        <div class="header-logo-wrapper col-auto p-0">
            <div class="logo-wrapper"><a href="{{ route('admin.dashboard') }}">
                <img class="img-fluid"
                        src="{{ asset('assets/admin/images/logo/logo.png') }}" alt="">
                    </a>
                </div>
            ...
            <ul class="nav-menus">
                <li class="profile-nav onhover-dropdown p-0 me-0">
                    <div class="media profile-media">
                        <img class="b-r-10" width="30px" src="{{ asset('assets/admin/images/favicon.png') }}" alt="">
                    ...
                    <ul class="profile-dropdown onhover-show-div">
                        <li>
                            ...
                            <form id="logout-form" action="{{ route('admin.logout') }}" method="POST">
                                @csrf
                                <button class="btn btn-dark px-3 bg_dark" type="submit">

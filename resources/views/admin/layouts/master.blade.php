...
<body>
    ...
    <div id="preloaderSmall" class="loader-active">
        <div id="loaderSmall">
            <img class="zoom-in-zoom-out" width="100px" src="{{asset('assets/admin/images/logo.png')}}" alt="Loader Icon">
        </div>
    </div>
    <!-- Loader End -->
        ...
        <div class="page-body-wrapper">
            ...
            {{-- <div id="preloaderSmall" class="loader-active">
                ...
                <div class="loaderSmallImage">
                    <img src="{{ asset('assets/admin/images/fabIcon.webp') }}" alt="fabIcon">
                </div>
                </div> --}}

                            ...
                            <div class="row">
                                    ...
                                    <ul class="specs_list">
                                        ...
                                        <li>
                                            <input type="checkbox" class="btn-check" id="credit_card"  value="Credit Card" name="payment_modes[]"
                                                autocomplete="off">
                                            <label class="btn btn-outline-dark custom_btn" for="credit_card">Credit
                                                Card</label>
                                        </li>
                                        <li>
                                            <input type="checkbox" class="btn-check" value="Debit Card" id="debit_card" name="payment_modes[]"
                                                autocomplete="off">
                                            <label class="btn btn-outline-dark custom_btn"  for="debit_card">Debit
                                                Card</label>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <input type="checkbox" class="btn-check" value="Bitcoin/Crypto" id="bitcoin/crypto" name="payment_modes[]"
                                                autocomplete="off">
                                            <label class="btn btn-outline-dark custom_btn" for="bitcoin/crypto"> Bitcoin /
                                                Crypto</label>
                                        </li>
                                    </ul>
                                </div>
                                    ...
                                    <ul class="specs_list">
                                        ...
                                        <li>
                                            <input type="radio" class="btn-check" id="sedan"
                                                name="car_fleet" autocomplete="off">
                                            <label class="btn btn-outline-dark custom_btn"
                                                for="sedan">Sedan</label>
                                        </li>
                                        <li>
                                            <input type="radio" class="btn-check" id="luxury_car"
                                                name="car_fleet" autocomplete="off">
                                            <label class="btn btn-outline-dark custom_btn"
                                                for="luxury_car">Luxury Car</label>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <input type="radio" class="btn-check" id="crossover"
                                                name="car_fleet" autocomplete="off">
                                            <label class="btn btn-outline-dark custom_btn"
                                                for="crossover">Crossover</label>
                                        </li>
                                        <li>
                                            <input type="radio" class="btn-check" id="compact"
                                                name="car_fleet" autocomplete="off">
                                            <label class="btn btn-outline-dark custom_btn"
                                                for="compact">Compact</label>
                                        </li>
                                        <li>
                                    ...
                                    <ul class="specs_list">
                                        ...
                                        <li>
                                            <input type="checkbox" value="English" class="btn-check" id="english"
                                                name="languages[]" autocomplete="off">
                                            <label class="btn btn-outline-dark custom_btn"
                                ...
                                <div class="col-12">
                                    <ul class="specs_list">
                                        ...
                                        <li>
                                            <li>
                                                <input placeholder="e.g. 24 Hours" class="form-control" name="city" value="{{Auth::user()->city}}" type="text" required>
                                            </li>
                                        </li>

...
// var section = $('#heroSection');
//        if ($(window).width() <= 768) { // Mobile screen size
//            section.css('background', "url('https://example.com/path/to/mobile-image.jpg')");
//        } else { // Desktop screen size
//            section.css('background', "url('https://driftcarrental.com/public/front_assets/images/home/banner.webp')");
//        }
//    }
//
//    $(document).ready(function() {
//        setBackground(); // Set background on load
//        $(window).resize(setBackground); // Set background on resize
//    });
